 ...
 * @author Alan Fowler
 * @author Jieun Lee
 * @version 1.3 (added setWidth and setHeight methods.)
 */
public class Board extends Observable {
    ...
    /**
     * The minimum width of a Tetris game board.
     */
    private static final int MINIMUM_WIDTH = 5;
    
    /**
     * The minimum height of a Tetris game board.
     */
    ...
    //public setter methods added by Jieun
    
    /**
     * Set the width of the board.
     * 
     * @param theWidth Width of the board.
     */
    public void setWidth(final int theWidth) {
        if (theWidth < MINIMUM_WIDTH) {
            throw new IllegalArgumentException("The width of the board sould be more than 4");
        }
        myWidth = theWidth;
    }
    ...
    public void setHeight(final int theHeight) {
        if (theHeight < MINIMUM_HEIGHT) {
            throw new IllegalArgumentException("The height of the board sould be more than 2");
        }
        myHeight = theHeight;
    }
